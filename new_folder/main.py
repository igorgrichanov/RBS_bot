...
def send_welcome(message):
    try:
        ...
        print(now2 + " - " + message.from_user.username + " - " + str(message.chat.id) + " - start")
...
def work_acc(message):
    try:
        ...
        print(now2 + " - " + message.from_user.username + " - " + str(message.chat.id) + " - " + requests_bot)
        user = db.get_user(user_id, user_name)
